package br.com.dicionariofutebolistico.service;
...
public class ChatFutDicio {
    ...
    public String getAnswerFromAi(String question) {
        try {
            ...
            if (isGreeting(question)) {
                prompt = "Diga 'Olá! Tudo bem? Sou uma IA especializada sobre tudo que é relacionado a Futebol, como posso ajudar?'";
            } else if (!isRelatedToESG(question)) { 
                // Retorna uma resposta padrão se o assunto for irrelevante
                return "Posso ajudar somente com assuntos relacionados a Futebol. Por favor, pergunte algo sobre o universo futebolístico!";
            } else {
                prompt = "Você é um especialista em tudo sobre Futebol. Responda apenas a perguntas sobre Futebol. Pergunta: " + question;
            }
    ...
    private boolean isRelatedToESG(String question) {
        String[] esgKeywords = {"futebol", "futebol masculino", "futebol feminino", "futvolei", "futsal", "futebol de areia", "futebol de campo", "futebol nacional", "futebol internacional"};
